<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Editing_cook.ascx.cs" Inherits="GolhaRestaurant_main_.Control.Edit.Editing_cook" %>
...
<script type="text/javascript">
    ...
    function mouseOut() {
       ...
       <a href="../../Main_page.aspx?id=cedit" id="areturn" dir="rtl" style="text-decoration:none;color:#6C9CFF"
      ...
      <p>
        ...
        <p>     
            شرح:<FCKeditorV2:FCKeditor ID="FCKeditor1" DefaultLanguage="fa" runat="server" Height="500px" BasePath="fckeditor/">
